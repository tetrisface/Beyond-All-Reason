...
local function InitializeUnits()
	...
	if IsReplayCheckpointVisualCleanupActive() then
		...
		spEcho("[ReplayCheckpoint] Sensor Ranges Jammer skipped restore initialize during visual cleanup")
		return
	end
...
function widget:Update(dt)
	...
	InitializeUnits()
	spEcho("[ReplayCheckpoint] Sensor Ranges Jammer rebuilt range state after visual cleanup")
end

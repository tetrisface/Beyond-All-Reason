...
local options = {
    ...
    {
        key     = "ecobench_enabled",
        name    = "EcoBench Enabled",
        desc    = "Enable the headless economy benchmark controller and telemetry exporter.",
        section = "dev",
        type    = "bool",
        def     = false,
        hidden  = true,
    ...
    {
        key     = "ecobench_target_frame",
        name    = "EcoBench Target Frame",
        desc    = "Frame at which EcoBench ends the benchmark.",
        section = "dev",
        type    = "number",
        def     = 21600,
        min     = 300,
    ...
    {
        key     = "ecobench_telemetry_interval",
        name    = "EcoBench Telemetry Interval",
        desc    = "Frames between EcoBench telemetry records.",
        section = "dev",
        type    = "number",
        def     = 150,
        min     = 15,
    ...
    {
        key     = "ecobench_policy",
        name    = "EcoBench Policy",
        desc    = "Comma-separated policy weights for EcoBenchAI, for example energy_weight=1,converter_weight=1.",
        section = "dev",
        type    = "string",
        def     = "",
        hidden  = true,
